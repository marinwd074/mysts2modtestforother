...
- MP-2C bounded N-action 合同：`MultiplayerSafeExecuteChecks` 当前 40 项通过，新增六动作有限上限、5-action session 迁移、连续安全前缀、首个不安全动作硬边界、超过 ceiling、完成/中止 session 不可重用等检查；Release 构建已通过，实机 Smoke 待本轮收口。
