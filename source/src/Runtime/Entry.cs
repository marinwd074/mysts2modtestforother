...
public static class Entry
{
    ...
    public static void Initialize()
    {
        ...
        {
            // Keep the mod loadable if the desktop is unavailable (for example,
            // a restricted headless account); normal desktop installs use the
            // centralized report directory above.
            centralizedLogs = false;
            logDirectory = Path.Combine(OS.GetUserDataDir(), "logs", "CombatSolver");
            GD.PrintErr($"[CombatSolver] Could not initialize centralized diagnostics: {error}");
        }
