...
internal sealed partial class SimulatedCombatState
{
    ...
    {
        fingerprint.Add('p');
        // Fingerprint only contains captured/readable players. Multiplayer local-core
        // captures one local player even when the live combat roster has multiple players.
