...
def main():
    ...
    if not Path("/proc/self/status").exists():
        parser.error("This optional research runner requires Linux /proc; use the native launchers on other platforms.")
    ...
    cmd = launcher + [
        ...
        "--evidence-directory", str(output), "--scenario-id", "PERFORMANCE-GENERATED",
