...
fail-closed reasons for non-card actions, missing/local ownership, replay/end-turn
semantics, remote or unknown targets, and route-bounded multi-action execution.
