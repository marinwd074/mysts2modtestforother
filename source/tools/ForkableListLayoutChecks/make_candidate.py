...
source = (repo / 'src/Search/ForkableCollections.cs').read_text(encoding='utf-8')
...
args.output.write_text(head + 'internal sealed class ForkableDictionary' + tail, encoding='utf-8')
