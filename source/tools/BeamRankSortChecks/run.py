...
sort = block(retention_source, 'private void SortByLegacyBeamRank(List<SearchNode> ranked)').replace('private void SortByLegacyBeamRank', 'public void SortByBeamRank', 1)
